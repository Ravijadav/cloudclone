...
mongoose.connect('mongodb://clouddata-0.cloud1.2971.mongodbdns.com/houseServices',function(err){if(err){console.log('can not connect succesfully')}});
...
mongoose.connect('mongodb://clouddata-0.cloud1.2971.mongodbdns.com/houseServices',function(err){if(err){console.log(err)}});
