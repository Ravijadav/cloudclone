...
var conn=mongoose.connect('mongodb://clouddata-2.cloud1.2971.mongodbdns.com:27000/houseServices',function(err){
...
$ = cheerio.load("<!DOCTYPE html> " +
      ...
      "</html>");
   	...
   	provider
        ...
        $("#"+link).attr({"href":"http://52.74.158.222:3000/providers/"+elem.eventName+"/"+user});
        ...
        $('#form_id').attr({"action":"http://52.74.158.222:3000/consumers/searchEvents/"+interest+"/"+user,
                            "method":"get"});
        res.send(200,$.html());  
});
});
